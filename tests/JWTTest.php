...
class JWTTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDecodeByJWKKeySetTokenExpired()
    {
        ...
        $this->setExpectedException('Memiah\JWT\ExpiredException');
    ...
    {
        $this->setExpectedException('Memiah\JWT\BeforeValidException');
        $payload = array(
            "message" => "abc",
    ...
    public function testInvalidToken()
    {
        $payload = array(
            ...
            "exp" => time() + 20); // time in the future
        $encoded = JWT::encode($payload, 'my_key');
        $this->setExpectedException('Memiah\JWT\SignatureInvalidException');
